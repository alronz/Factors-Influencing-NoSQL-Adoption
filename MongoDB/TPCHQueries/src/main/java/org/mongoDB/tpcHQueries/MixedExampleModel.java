...
public class MixedExampleModel {
    ...
    public MixedExampleModel(MongoClient mongoClient) {
    ...
    private void createCustomer() {
        ...
        if (this.database.getCollection("mixed_customer") == null) {
            ...
            this.database.getCollection("mixed_customer").drop();
            this.database.createCollection("mixed_customer");
        }

        mixed_customer = this.database
                .getCollection("mixed_customer");
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                this.mixed_customer.insertOne(customer);
            }
    ...
    void createSupplier() {
        ...
        if (this.database.getCollection("mixed_supplier") == null) {
            ...
            this.database.getCollection("mixed_supplier").drop();
            this.database.createCollection("mixed_supplier");
        }

        mixed_supplier = this.database
                .getCollection("mixed_supplier");
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                this.mixed_supplier.insertOne(supplier);
            }
    ...
    void createPartSupp() {
        ...
        if (this.database.getCollection("mixed_partsupp") == null) {
            ...
            this.database.getCollection("mixed_partsupp").drop();
            this.database.createCollection("mixed_partsupp");
        }

        mixed_partsupp = this.database
                .getCollection("mixed_partsupp");
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                partsupp.append("SUPPKEY", lineFields[1]).append("AVAILQTY", Double.valueOf(lineFields[2]))
                ...
                this.mixed_partsupp.insertOne(partsupp);
            }
    ...
    void createOrder() {
        ...
        if (this.database.getCollection("mixed_order") == null) {
            ...
            this.database.getCollection("mixed_order").drop();
            this.database.createCollection("mixed_order");
        }

        mixed_order = this.database
                .getCollection("mixed_order");
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                this.mixed_order.insertOne(order);
            }
